...
namespace SchoolAccount.Web.Connect.UnitTests.Features.Tasks.GetById;

public static class GetTaskByIdViewModelTests
{
    public class HeadingText
    {
        ...
        public void Returns_upcoming_tasks_when_view_mode_is_upcoming()
        {
            ...
            var sut = new GetTaskByIdViewModel(taskResponse, UpcomingTasks);
        ...
        public void Returns_previous_12_months_when_view_mode_is_previous()
        {
            // Arrange
            var taskResponse = new GetTaskByIdResponse();
            var sut = new GetTaskByIdViewModel(taskResponse, PreviousTasks);
        ...
        public void Returns_upcoming_tasks_when_view_mode_is_not_supplied()
        {
            // Arrange
            var taskResponse = new GetTaskByIdResponse();
            var sut = new GetTaskByIdViewModel(taskResponse);
    ...
    public class Subtasks
    {
        ...
        public void Returns_published_subtasks_when_view_mode_is_upcoming()
        {
            ...
            var sut = new GetTaskByIdViewModel(getTaskByIdResponse, UpcomingTasks);
        ...
        public void Returns_expired_subtasks_when_view_mode_is_previous()
        {
            ...
            var sut = new GetTaskByIdViewModel(getTaskByIdResponse, PreviousTasks);
