...
internal static class PageTemplateHelper
{
    ...
    {
        return "/lib/moj-frontend/moj-frontend-6.0.0.min.js";
    }

    internal static string GetMojScriptInlineScript()
    {
        return "import * as MOJFrontend from '/lib/moj-frontend/moj-frontend-6.0.0.min.js'; MOJFrontend.initAll();";
    }

    internal static string GetMojStyleAssetUrl()
    {
        return "/lib/moj-frontend/moj-frontend-6.0.0.min.css";
    }
