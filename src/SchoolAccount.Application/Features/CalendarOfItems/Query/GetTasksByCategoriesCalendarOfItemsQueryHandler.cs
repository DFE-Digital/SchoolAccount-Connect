...
public class GetTasksByCategoriesCalendarOfItemsQueryHandler(
    IQueryAggregator aggregator,
    IApplicationDbContext applicationDbContext,
    IOrganisationContext organisationContext
) : IQueryHandler<GetTasksByCategoriesCalendarOfItemsQuery, QueryPagedResult<CalendarOfItemsRow>>
{
    public async Task<Result<QueryPagedResult<CalendarOfItemsRow>>> Handle(
        GetTasksByCategoriesCalendarOfItemsQuery query,
