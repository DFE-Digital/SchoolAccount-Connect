...
public class QueryFactoryForAsanaIntegrationsForCalendarOfItems(IHttpClientFactory clientFactory)
    : IQueryFactory<CalendarOfItemsRow>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        using var response = await client.GetAsync("http://127.0.0.1:5000/integrations/asana/tasks", cancellationToken);
