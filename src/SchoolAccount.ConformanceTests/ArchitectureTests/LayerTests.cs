...
public class LayerTests : BaseTest
{
    ...
    public void DomainLayerShouldNotHaveADependencyOnApplicationLayer()
    {
        ...
        result.IsSuccessful
            .Should()
            .BeTrue("Domain layer should not have a dependency on the application layer.");
    }
    ...
    public void DomainLayerShouldNotHaveADependencyOnInfrastructureLayer()
    {
        ...
        result.IsSuccessful
            .Should()
            .BeTrue("Domain layer should not have a dependency on the infrastructure layer.");
    }
    ...
    public void DomainLayerShouldNotHaveADependencyOnPresentationLayer()
    {
        ...
        result.IsSuccessful
            .Should()
            .BeTrue("Domain layer should not have a dependency on the presentation layer.");
    }
