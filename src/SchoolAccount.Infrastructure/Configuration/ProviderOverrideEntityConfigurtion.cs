...
public sealed class ProviderOverrideEntityConfiguration : IEntityTypeConfiguration<ProviderOverrideEntity>
{
    ...
    {
        builder.ToTable(TableConstants.Administrative.ProviderOverride, SchemaConstants.Transactional).HasKey(x => x.Id);
        ...
        builder.Property(x => x.SchoolName).HasColumnName(ColumnNames.SchoolName).HasMaxLength(int.MaxValue).IsRequired();
